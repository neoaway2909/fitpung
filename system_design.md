...
*   **เพิ่ม/ลดสต็อกสินค้า:** อ่านและเขียนทับไฟล์ `products.json` ของ  ระบบแสดงและค้นหาสินค้าหน้าบ้าน
*   **อัปเดตสถานะการจัดส่ง (Tracking):** แก้ไขฟิลด์ status ใน `orders.json` ของระบบคำสั่งซื้อและการชำระเงิน
*   **จัดการพนักงาน (เพิ่ม/ลบ พนักงาน):** เพิ่มข้อมูลลง `users.json` ของ ระบบสมาชิกและการเข้าสู่ระบบ โดยตั้ง role เป็น 'staff'
